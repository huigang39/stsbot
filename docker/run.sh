...
function show_help() {
  ...
  Options:\n
  \t-i --image_name\t\t Name of the image to be run (default ros2_humble_eaibot).\n
  \t-c --container_name\t Name of the container(default ros2_humble_eaibot_container).\n
...
IMAGE_NAME=${IMAGE_NAME:-ros2_humble_eaibot}
CONTAINER_NAME=${CONTAINER_NAME:-ros2_humble_eaibot_container}
