...
def generate_launch_description():
    ...
    # Obtains eaibot_description's share directory path.
    pkg_eaibot_description = get_package_share_directory('eaibot_description')

    # Obtain urdf from xacro files.
    doc = xacro.process_file(os.path.join(pkg_eaibot_description, 'urdf', 'eaibot.urdf.xacro'))
    ...
    rviz = Node(
        package='rviz2',
        executable='rviz2',
        arguments=['-d', os.path.join(pkg_eaibot_description, 'rviz', 'eaibot_description.rviz')],
