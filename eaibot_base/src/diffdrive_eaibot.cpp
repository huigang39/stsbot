...
#include "eaibot_base/diffdrive_eaibot.h"
...
namespace eaibot_base
{
    ...
    hardware_interface::CallbackReturn DiffDriveeaibot::on_init(const hardware_interface::HardwareInfo &info)
    {
        ...
        {
            // DiffDriveeaibot has exactly two states and one command interface on each joint
    ...
    hardware_interface::CallbackReturn DiffDriveeaibot::on_configure(const rclcpp_lifecycle::State & /*previous_state*/)
    {
    ...
    std::vector<hardware_interface::StateInterface> DiffDriveeaibot::export_state_interfaces()
    {
    ...
    std::vector<hardware_interface::CommandInterface> DiffDriveeaibot::export_command_interfaces()
    {
    ...
    hardware_interface::CallbackReturn DiffDriveeaibot::on_activate(const rclcpp_lifecycle::State & /* previous_state */)
    {
    ...
    hardware_interface::CallbackReturn DiffDriveeaibot::on_deactivate(const rclcpp_lifecycle::State & /* previous_state */)
    {
    ...
    hardware_interface::return_type DiffDriveeaibot::read(const rclcpp::Time & /* time */, const rclcpp::Duration &period)
    {
    ...
    hardware_interface::return_type DiffDriveeaibot::write(const rclcpp::Time & /* time */,
...
PLUGINLIB_EXPORT_CLASS(eaibot_base::DiffDriveeaibot, hardware_interface::SystemInterface)
